...
for i in range(N):
    ...
    #自分のコードを実行するためのコマンド
    proc = subprocess.Popen(f"cargo run --release --bin tester python3 /Users/morikouhei/github/programming_contest/atcoder/ahc/ahc018/na.py < in/{S}.txt > out/{S}.txt 2> score/{S}.txt", shell=True)#要変更
