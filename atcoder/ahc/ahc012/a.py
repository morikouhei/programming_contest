...
def climbing(ly):
    ...
    while last < 100 and time.time() - stime < 2.7:
        ...
        if action == 0: ### delete
            ...
            delta = new_score - temp_score
            if delta > 0 or random.random() < (100-abs(delta))/500:
    ...
    return best_score,best_X,Y


temp_score,temp_X,temp_Y = climbing(45)
